...
class Router 
{
    ...
    public static function init() : void
    {
        ...
        if (Config::get("admin_enabled") !== false) include("core/admin_routes.php");
    }
     ...
     */
    public static function get_route(string $path, mixed $callback, string $name=null, array $middlewares=[],  array $methods=[]) : array
    {
        $new_routes = [
            "path"          => $path,
            "callback"      => $callback,
    ...
    public static function route_current() : void
    {
        ...
        {
            //echo $route["regex"] . " : ". preg_match($route["regex"], $req_path) . "<br>";
